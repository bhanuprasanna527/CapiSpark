function Features() {
    return (
        <div class="bg-gray-100">
            <div class="mx-auto max-w-4xl bg-gray-100">
                <section class="bg-gray-100">
                    <div
                        class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                        <img class="w-full rounded-3xl"
                             src="https://framerusercontent.com/images/NM1JbsBunC7Sdw4xO5Gr1tUkbIY.jpg"
                             alt="dashboard image" />
                ...
                <section class="bg-gray-100">
                    <div
                        class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                        <img class="w-full rounded-3xl sm:hidden"
                             src="https://framerusercontent.com/images/aF1qs0zdtLkC6oolabfIM16OqYI.jpg"
                             alt="dashboard image" />
                            <div class="mt-4 md:mt-0">
                            ...
                            <img class="w-full rounded-3xl hidden sm:block"
                                 src="https://framerusercontent.com/images/aF1qs0zdtLkC6oolabfIM16OqYI.jpg"
                                 alt="dashboard image" />
                    </div>
                </section>
                ...
                <section class="bg-gray-100">
                    <div
                        class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                        <img class="w-full rounded-3xl"
                             src="https://framerusercontent.com/images/gpq1OkEpJxVpgRBEElLRhIiDk7w.jpg"
                             alt="dashboard image" />
                            <div class="mt-4 md:mt-0">
